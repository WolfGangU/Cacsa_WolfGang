        ...
        <!-- Optionally, you can add icons to the links -->
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="verclientesfisicos.php">Personas físicas</a></li>
          </ul>
        </li>
          ...
          <ul class="treeview-menu">
            <li><a href="agregarproyecto.php">Nuevo Proyecto</a></li>
            <li><a href="verproyectoscurso.php">Proyectos en curso</a></li>
            <li><a href="verproyectosterm.php">Proyectos Terminados</a></li>
          </ul>
        </li>
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="listadegiros.php">Giros comerciales</a></li>
            <li><a href="listaderutas.php">Rutas</a></li>
            <li><a href="listadesalida.php">Orden salida/Entrega</a></li>
            <li><a href="listaderetiro.php">Orden Retiro/Recolección</a></li>
            <li><a href="listadereparacion.php">Orden de Reparación</a></li>
