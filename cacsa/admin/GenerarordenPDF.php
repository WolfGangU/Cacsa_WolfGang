...
function ConsultarProducto( $id_pro )
{
 ...
 $pdf->Cell(5);
 $pdf->Cell(180,5,'Carta Entrega',1,1,'C',1);
$pdf->SetTextColor(0,0,0);
 ...
 $pdf->Cell(5);
 $pdf->Cell(180,5,'Por medio de la presente se notifica la entrega del siguiente equipo para renta;',1,1,'C',1);
 $pdf->Cell(5);
...
$pdf->Cell(40,10,'Firma del Cliente',0,1);
 ...
 $pdf->Output('I','OR_E'.utf8_decode($consulta[2]).'.pdf');//im
?>
?>