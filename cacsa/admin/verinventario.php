    ...
    var listar = function(){
      ...
      var table = $("#dt_pyt").DataTable({
          ...
          "columns":[
                  ...
                  {"data":"nombre_giro"},
                  {"data":"cantidad"},
                  {render: function (data, type, row){return `<a class="btn btn-primary" href="Modif_producto.php?id=${row.id_producto}" role="button">Modificar</a> <a href="PHP/Elimnar_productos.php?id=${row.id_producto}"  class="btn btn-danger">Eliminar</a>`}}
