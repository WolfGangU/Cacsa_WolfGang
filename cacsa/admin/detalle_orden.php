    ...
    var listar = function(){
      ...
      var table = $("#dt_pyt").DataTable({
          ...
          "columns":[
                  ...
                  {"data":"nombre_giro"},
                  {"data":"cantidad"},
                  {render: function (data, type, row){return `<a class="btn btn-primary" href="Agregardetpro.php?od=${row.id_producto}&id=<?php echo $_GET['id'] ?>" role="button">Producto a enviar</a>`}}
