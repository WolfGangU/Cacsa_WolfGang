...
include 'conexion.php' ;
$query=mysqli_query($conexion,"SELECT o.id_orden,p.nombre_proy FROM orden_entrega o inner JOIN proyectos p ON o.id_proyecto = p.id_proyecto WHERE p.est_pro = 1 and o.est_ord_e=1 and o.id_orden='".$consulta[1]."';");
...
include 'conexion.php' ;
$query=mysqli_query($conexion,"SELECT id_lugar, nombre_lugar FROM lugares where id_lugar='".$consulta[2]."'");
...
?>
    ...
    ?>
     <?php 
    if($consulta[3]==$datos['id_operador']){
        ?>
    <option value="<?php echo $datos['id_operador'] ?>" selected="selected"> <?php echo $datos['nombres'] ?> </option>
    <?php
    }
    ?>
...
?>
    ...
    ?>
     <?php 
    if($consulta[4]==$datos['id_giro']){
        ?>
    <option value="<?php echo $datos['id_giro'] ?>" selected="selected"> <?php echo $datos['nombre_giro'] ?> </option>
    <?php
    }
    ?>
    ...
    case "Lunes,Miercoles,Viernes":
        ?>
          <option value="Lunes,Miercoles,Viernes"selected="selected">Lunes,Miércoles,Viernes</option>
        <?php
    ...
    case "Lunes-Sabado":
       ?>
          <option value="Lunes-Sabado"selected="selected">Lunes-Sabado</option>
        <?php
        break;
        case "Lunes-Domingo":
       ?>
          <option value="Lunes-Domingo"selected="selected">Lunes-Domingo</option>
        <?php
        break;
        case "Martes,Jueves,Sabado":
       ?>
          <option value="Martes,Jueves,Sabado"selected="selected">Martes,Jueves,Sabado</option>
        <?php
        break;
      case "Por Dia":
       ?>
          <option value="Por Dia"selected="selected">Por Dia</option>
        <?php
        break;
