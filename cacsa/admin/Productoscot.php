...
inv.id_lugar = lug.id_lugar inner join detalle_rutatemp tmp
...
$result= mysqli_query($conexion,$sql);  
    ...
    ?>
    <tr>
      <th scope="col"><?php echo $mostrar['codigo'] ?></th>
      <th scope="col"><?php echo $mostrar['descrip'] ?></th>
      <th scope="col"><?php echo $mostrar['nombre_lugar'] ?></th>
      <th scope="col"><?php echo $mostrar['nombre_giro'] ?></th>

      <th scope="col"> <a href="Elimnar_productostemp.php?id=<?php echo $mostrar['id_producto']?>"  class="btn btn-danger">Eliminar</a>
        </th>
    </tr>
...
<div class="form-group">
    <div class="col-lg-offset-2 col-lg-10">
      <button type="submit" class="btn btn-primary">Agregar Productos a la orden</button>
    </div>
    ...
    var listar = function(){
      ...
      var table = $("#dt_pyt").DataTable({
          ...
          "columns":[
                  ...
                  {"data":"nombre_giro"},
                  {"data":"cantidad"},
                  {render: function (data, type, row){return `<a class="btn btn-primary" href="Agregartemp.php?od=${row.id_producto}&id=<?php echo $_GET['id'] ?>&lug=<?php echo $consulta[1]?>" role="button">Producto a enviar</a>`}}
